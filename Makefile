...
all: unit-tests litestream-exporter image-litestream-exporter lint
...
.PHONY: $(ARTIFACTS)/litestream-exporter-linux-amd64
$(ARTIFACTS)/litestream-exporter-linux-amd64:
	@$(MAKE) local-litestream-exporter-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: litestream-exporter-linux-amd64
litestream-exporter-linux-amd64: $(ARTIFACTS)/litestream-exporter-linux-amd64  ## Builds executable for litestream-exporter-linux-amd64.

.PHONY: $(ARTIFACTS)/litestream-exporter-linux-arm64
$(ARTIFACTS)/litestream-exporter-linux-arm64:
	@$(MAKE) local-litestream-exporter-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: litestream-exporter-linux-arm64
litestream-exporter-linux-arm64: $(ARTIFACTS)/litestream-exporter-linux-arm64  ## Builds executable for litestream-exporter-linux-arm64.

.PHONY: litestream-exporter
litestream-exporter: litestream-exporter-linux-amd64 litestream-exporter-linux-arm64  ## Builds executables for litestream-exporter.
...
.PHONY: image-litestream-exporter
image-litestream-exporter:  ## Builds image for litestream-exporter.
	@$(MAKE) registry-$@ IMAGE_NAME="litestream-exporter"
